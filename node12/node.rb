class Node < Formula
  ...
  url "https://github.com/nodejs/node/archive/v12.13.1.tar.gz"
  ...
  def install
    ...
    args << "--with-icu-source=https://github.com/unicode-org/icu/releases/download/release-64-2/icu4c-64_2-src.zip"
